...
// IP on registration
				$flag = ip_country_to_flag(userid_to_userip($row['topic_poster']));
				$country = strtoupper($flag);

				$flag_last = ip_country_to_flag(userid_to_userip($row['topic_last_poster_id']));
				$country_last = strtoupper($flag_last);
...
*/
					'TOPIC_AUTHOR_FULL'			=> get_username_string('full', $row['topic_poster'], '<img src="images/flags/small/' .  $flag . '.png" width="14" height="9" alt="' . $user->lang['country'][$country] . '" title="' . $user->lang['country'][$country] . '" />' . ' ' .  $row['topic_first_poster_name'], $row['topic_first_poster_colour']),
// --- IP Country Flag Olympus end ----------------------
...
*/
					'LAST_POST_AUTHOR_FULL'		=> get_username_string('full', $row['topic_last_poster_id'], '<img src="images/flags/small/' .  $flag_last . '.png" width="14" height="9" alt="' . $user->lang['country'][$country_last] . '" title="' . $user->lang['country'][$country_last] . '" />' . ' ' . $row['topic_last_poster_name'], $row['topic_last_poster_colour']),
 // --- IP Country Flag Olympus end ----------------------
...
// --- IP Country Flag Olympus start --------------------
// IP in this posts
				$flag_poster = ip_country_to_flag($row['poster_ip']);
				$country_poster = strtoupper($flag_poster);
// --- IP Country Flag Olympus end ----------------------
				$tpl_ary = array(
// --- IP Country Flag Olympus start --------------------
// replace
...
*/
					'POST_AUTHOR_FULL'		=> get_username_string('full', $row['poster_id'], '<img src="images/flags/small/' .  $flag_poster . '.png" width="14" height="9" alt="' . $user->lang['country'][$country_poster] . '" title="' . $user->lang['country'][$country_poster] . '" />' . ' ' . $row['username'], $row['user_colour'], $row['post_username']),
// --- IP Country Flag Olympus end ----------------------
