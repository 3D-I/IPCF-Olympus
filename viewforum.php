...
// --- IP Country Flag Olympus start --------------------
		$flag_first = ip_country_to_flag(userid_to_userip($row['topic_poster']));
		$country_first = strtoupper($flag_first);

		$flag = ip_country_to_flag(userid_to_userip($row['topic_last_poster_id']));
...
*/
			'TOPIC_AUTHOR_FULL'			=> get_username_string('full', $row['topic_poster'], '<img src="images/flags/small/' .  $flag_first . '.png" width="14" height="9" alt="' . $user->lang['country'][$country_first] . '" title="' . $user->lang['country'][$country] . '" />' . ' ' . $row['topic_first_poster_name'], $row['topic_first_poster_colour']),
// --- IP Country Flag Olympus end ----------------------
...
*/
			'LAST_POST_AUTHOR_FULL'		=> get_username_string('full', $row['topic_last_poster_id'], '<img src="images/flags/small/' .  $flag . '.png" width="14" height="9" alt="' . $user->lang['country'][$country] . '" title="' . $user->lang['country'][$country] . '" />' . ' ' . $row['topic_last_poster_name'], $row['topic_last_poster_colour']),
// --- IP Country Flag Olympus end ----------------------
