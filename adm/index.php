...
// IP on registration
	$flag = ip_country_to_flag($user->data['user_ip']);
...
*/
		'USERNAME'				=> '<img src="../images/flags/small/' .  $flag . '.png" width="14" height="9" alt="' . $user->lang['country'][$country] . '" title="' . $user->lang['country'][$country] . '" />' . ' ' . $user->data['username'],
// --- IP Country Flag Olympus end ----------------------
