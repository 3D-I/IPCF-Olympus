...
*/
				$flag = ip_country_to_flag($user_row['user_ip']);
				$country = strtoupper($flag);

				$avatar_img = ($user_row['user_avatar']) ? get_user_avatar($user_row['user_avatar'], $user_row['user_avatar_type'], $user_row['user_avatar_width'], $user_row['user_avatar_height']) : '<img src="../images/avatars/gallery/avatar_flags/' .  $flag . '.gif" alt="' . $user->lang['country'][$country] . '" title="' . $user->lang['country'][$country] . '" />';
