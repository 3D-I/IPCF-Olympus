...
// --- IP Country Flag Olympus start --------------------
// IP on registration
			$flag_perm = ip_country_to_flag($user_row['user_ip']);
			$country_perm = strtoupper($flag_perm);
// --- IP Country Flag Olympus end ----------------------
...
*/
			$perm_from .= '<img src="../images/flags/small/' .  $flag_perm . '.png" width="14" height="9" alt="' . $user->lang['country'][$country_perm] . '" title="' . $user->lang['country'][$country_perm] . '" />' . ' ' . $user_row['username'];
// --- IP Country Flag Olympus end ----------------------
...
// --- IP Country Flag Olympus start --------------------
// IP on registration
				$flag = ip_country_to_flag(userid_to_userip($row['user_id']));
				$country = strtoupper($flag);
// IP on Logs
				$flag_row_ip = ip_country_to_flag($row['ip']);
				$country_row_ip = strtoupper($flag_row_ip);
// --- IP Country Flag Olympus end ----------------------
...
*/
					'USERNAME'	=> '<img src="../images/flags/small/' .  $flag . '.png" width="14" height="9" alt="' . $user->lang['country'][$country] . '" title="' . $user->lang['country'][$country] . '" />' . ' ' . $row['username_full'],
// replace
/*
					'IP'		=> $row['ip'],
*/					
					'IP'		=> '<img src="../images/flags/small/' .  $flag_row_ip . '.png" width="14" height="9" alt="' . $user->lang['country'][$country_row_ip] . '" title="' . $user->lang['country'][$country_row_ip] . '" />' . ' ' . $row['ip'],
// --- IP Country Flag Olympus end ----------------------
...
// --- IP Country Flag Olympus start --------------------
// IP on registration
				$flag_inactive = ip_country_to_flag(userid_to_userip($row['user_id']));
				$country_inactive = strtoupper($flag_inactive);
// --- IP Country Flag Olympus end ----------------------
...
*/
					'USERNAME'		=> '<img src="../images/flags/small/' .  $flag_inactive . '.png" width="14" height="9" alt="' . $user->lang['country'][$country_inactive] . '" title="' . $user->lang['country'][$country_inactive] . '" />' . ' ' . $row['username'],
// --- IP Country Flag Olympus end ----------------------
