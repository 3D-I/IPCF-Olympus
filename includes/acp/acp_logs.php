...
// IP on Logs
			$flag_row = ip_country_to_flag($row['ip']);
			$country_row = strtoupper($flag_row);
...
/*
				'IP'				=> $row['ip'],
*/
				'IP'				=> '<img src="../images/flags/small/' .  $flag_row . '.png" width="14" height="9" alt="' . $user->lang['country'][$country_row] . '" title="' . $user->lang['country'][$country_row] . '" />' . ' ' . $row['ip'],
// --- IP Country Flag Olympus end ----------------------
