...
// add
		$flag = ip_country_to_flag(userid_to_userip($row['forum_last_poster_id']));
...
*/
			'LAST_POSTER_FULL'		=> get_username_string('full', $row['forum_last_poster_id'], '<img src="images/flags/small/' .  $flag . '.png" width="14" height="9" alt="' . $user->lang['country'][$country] . '" title="' . $user->lang['country'][$country] . '" />' . ' ' . $row['forum_last_poster_name'], $row['forum_last_poster_colour']),
// --- IP Country Flag Olympus end ----------------------
...
function get_user_avatar($avatar, $avatar_type, $avatar_width, $avatar_height, $alt = 'USER_AVATAR')
{
	...
	if (empty($avatar) || !$avatar_type)
	{
		return '';
*/
function get_user_avatar($avatar, $avatar_type, $avatar_width, $avatar_height, $userip, $alt = 'USER_AVATAR')
{
	global $user, $config, $phpbb_root_path, $phpEx;
	global $db;
	...
	if (empty($avatar) || !$avatar_type)
	{
		$flag = ip_country_to_flag($userip);
		$country = strtoupper($flag);

		return '<img src="images/avatars/gallery/avatar_flags/' .  $flag . '.gif" alt="' . $user->lang['country'][$country] . '" title="' . $user->lang['country'][$country] . '" />';
// --- IP Country Flag Olympus end ----------------------
	}
