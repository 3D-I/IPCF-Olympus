...
// , u.user_ip
		$sql = $db->sql_build_query('SELECT', array(
			'SELECT'	=> 'u.user_id, u.group_id as default_group, u.username, u.username_clean, u.user_colour, u.user_rank, u.user_posts, u.user_allow_pm, u.user_ip, g.group_id, g.group_name, g.group_colour, g.group_type, ug.user_id as ug_user_id',
...
*/
		$poster_avatar = get_user_avatar($member['user_avatar'], $member['user_avatar_type'], $member['user_avatar_width'], $member['user_avatar_height'], $member['user_ip']);
// --- IP Country Flag Olympus end ----------------------
...
*/
		'AVATAR_IMG'		=> get_user_avatar($data['user_avatar'], $data['user_avatar_type'], $data['user_avatar_width'], $data['user_avatar_height'], $data['user_ip']),
// --- IP Country Flag Olympus end ----------------------
